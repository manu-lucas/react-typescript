...
export type InvoiceActions =
  | ISetInvoice
  | ISetIInvoiceLineItem
  | ISetDialogEditRecipient
  | ISetDialogSender;
...
export const invoice_setInvoiceLineItem = (
  payload: IPayloadSetInvoiceLineItem
): ISetIInvoiceLineItem => ({
...
export const invoice_setDialogRecipient = (
  payload: boolean
): ISetDialogEditRecipient => ({
...
export const invoice_setDialogSender = (
  payload: boolean
): ISetDialogSender => ({
