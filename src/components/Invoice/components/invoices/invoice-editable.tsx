...
import {
  invoice_setDialogRecipient,
  invoice_setDialogSender,
        ...
        <Container>
          ...
          >
            ...
            >
              <InvoiceCompanyLogo
                logo={invoice.logo}
                onUploadImage={updateLogo}
              />
              <InvoiceSender
                from={invoice.sender}
                handleOpenDialog={onOpenDialogEditSender}
              />
            </Box>
            <Box
              style={{
            ...
            >
              <InvoiceRecipient
                ...
                handleOpenDialog={onOpenDialogEditRecipient}
              />
              <InvoiceInfo
